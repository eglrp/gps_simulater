function [ddph1, ddph2, ddN1, ddN2, ddpr1, dde1] = GNSS_Carrier_DD(t,pr1_M, ph1_M, pr2_M, ph2_M, N1_M, N2_M, e1_Mx, e1_My,e1_Mz, dop1_M, dop2_M, pr1_R, ph1_R, pr2_R, ph2_R, N1_R, N2_R, e1_R, dop1_R, dop2_R)
%   产生双差载波观测量
%   input：   
...
for i=1:  nsat         %   i代表哪颗卫星
       for j=1:  sign_set.datalength     %  j代表第几个采样点
          ...
          de1(i,:,j)=e1_M(i,:,j)+e1_R(i,:,j);                    % 计算方向余弦 
